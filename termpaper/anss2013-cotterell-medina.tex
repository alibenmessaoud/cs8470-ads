...
$$ \qquad\operatorname{\sigma}(\alpha_i, \beta_j) = \begin{cases}
  0 &: i=j=0 \\
  i &: j = 0 \text{ and } i > 0 \\
  j &: i = 0 \text{ and } j > 0 \\
  \min \begin{cases}
          \operatorname{\sigma}(\alpha_{i-1}, \beta_j) + 1 \\
          \operatorname{\sigma}(\alpha_i, \beta_{j-1}) + 1 \\
          \operatorname{\sigma}(\alpha_{i-1}, \beta_{j-1}) + [\alpha_i \neq \beta_j]
       \end{cases} &: \text{ else}
\end{cases} $$
