...
Precision is defined as the ratio of the number of correct correspondences to the total number
...
The converse of the precision metric is the recall metric, which provides a penalty for 
...
Finally, we consider the F-measure, a metric that provides a balance between precision and
recall. 
