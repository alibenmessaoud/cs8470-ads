...
\begin{tikzpicture}
   \Vertex[x=0, y=4]{AD}   \Vertex[x=2, y=4]{BD}   \Vertex[x=4, y=4]{CD}
   \Vertex[x=0, y=2]{AE}   \Vertex[x=2, y=2]{BE}   \Vertex[x=4, y=2]{CE}
   \Vertex[x=0, y=0]{AF}   \Vertex[x=2, y=0]{BF}   \Vertex[x=4, y=0]{CF}
\end{tikzpicture}
